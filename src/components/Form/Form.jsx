...
const Form = () => {
  ...
  const calculateDeliveryPrice = () => {
    if (deliveryMethod === 'pickup') return 'Безкоштовно';
    if (selectedLocation && deliveryMethod === 'courier') {
      ...
      const deliveryPrice = 20 + distance * 1; // Adjust calculation as necessary
  ...
  const calculateDeliveryTime = () => {
    if (selectedLocation && deliveryMethod === 'courier') {
      ...
      const totalTimeInMinutes = Math.round(timeHours * 60) + 10; // Adding 10 minutes of preparation time
